...
const Skils = () => (
  ...
  <div className="Skill" id="skils">
    ...
    {/* Basic(기본) Intermediate(중급) Expert(전문가) */}
      ...
      <div className="Skill_image_container" style={{backgroundImage: `url(${JS})`}}><div className="Skill_label">Basic</div></div>
    ...
    <div className="Skill_image_container" style={{backgroundImage: `url(${BootStrap})`}}><div className="Skill_label">Intermediate</div></div>
